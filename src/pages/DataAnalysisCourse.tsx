...
import { BookOpen, CheckCircle, AlertCircle, ChevronRight, RefreshCw, Star, ChevronLeft } from 'lucide-react';
...
const courseOutline = [
  ...
  },
  {
    ...
    content: `
      ...
      <h3>7.6 销售数据可视化</h3>
      <p><strong>核心工具/函数:</strong> plot, bar, pie, line (Pandas内置), matplotlib, seaborn</p>
      <p><strong>业务目标:</strong> 销售趋势、地区分布、品类占比可视化，图表叙事与洞察总结</p>
      
      <h3>7.7 A/B测试效果分析</h3>
      <p><strong>核心工具/函数:</strong> groupby, crosstab, scipy.stats (T-test/Chi2)</p>
      <p><strong>业务目标:</strong> 实验数据统计、转化率差异显著性检验、P值解读与方案评估</p>
      ...
      <h3>7.10 客户RFM价值分层</h3>
      <p><strong>核心工具/函数:</strong> qcut, map, apply, 自定义评分函数</p>
      <p><strong>业务目标:</strong> 基于RFM的客户价值分层、业务标签定义与分层运营策略制定</p>
